...
/* {# inline_template_start #}<div class="part-info" id="part-{{ nid }}" data-nid="{{ nid }}">{{ field_rate}}</div> */
class __TwigTemplate_4425f049de7943c874299df9a150ae85f6e858c728c4b80d4387c7671452c7d9 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<div class=\"part-info\" id=\"part-{{ nid }}\" data-nid=\"{{ nid }}\">{{ field_rate}}</div>";
    }
